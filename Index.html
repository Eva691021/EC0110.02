    ...
    <style>
        ...
        @media print {
            ...
            #receiptSection img[alt="Logo Montealegre"] {
                max-width: 120px !important; /* Ensure Montealegre logo scales well */
            }
    ...
    <header class="bg-blue-800 text-white p-6 shadow-xl">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div class="flex items-center space-x-4">
                <img src="https://github.com/Eva691021/EC0110.02/blob/main/WhatsApp%20Image%202024-02-22%20at%2010.47.05%20PM.jpeg?raw=true" alt="Logo Montealegre" class="h-auto max-w-sm">
    ...
    <section id="receiptSection" class="hidden p-8 bg-white rounded-xl shadow-lg border border-gray-200 mx-auto my-10 max-w-3xl">
        <div class="text-center mb-8">
            <div class="flex justify-center items-center space-x-4 mb-4">
                <img src="https://github.com/Eva691021/EC0110.02/blob/main/WhatsApp%20Image%202024-02-22%20at%2010.47.05%20PM.jpeg?raw=true" alt="Logo Montealegre" class="h-auto max-w-xs">
